...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coupon.item_type'
        db.alter_column(u'cms_coupon', 'item_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Coupon.item_sub_type'
        db.alter_column(u'cms_coupon', 'item_sub_type', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Coupon.item_type'
        db.alter_column(u'cms_coupon', 'item_type', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Coupon.item_sub_type'
        db.alter_column(u'cms_coupon', 'item_sub_type', self.gf('django.db.models.fields.CharField')(max_length=50))
