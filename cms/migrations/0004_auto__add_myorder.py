...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'cms', ['MyOrder'])

        # Adding M2M table for field options on 'MyOrder'
        m2m_table_name = db.shorten_name(u'cms_myorder_options')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('myorder', models.ForeignKey(orm[u'cms.myorder'], null=False)),
            ('option', models.ForeignKey(orm[u'cms.option'], null=False))
        ))
        db.create_unique(m2m_table_name, ['myorder_id', 'option_id'])


    def backwards(self, orm):
        # Deleting model 'MyOrder'
        db.delete_table(u'cms_myorder')

        # Removing M2M table for field options on 'MyOrder'
        db.delete_table(db.shorten_name(u'cms_myorder_options'))
    ...
    models = {
        ...
        u'cms.order': {
            ...
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cms.Coupon']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'options': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'order_options'", 'null': 'True', 'to': u"orm['cms.Option']"}),
            'regdate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'subscription_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'useable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'usedate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'})
